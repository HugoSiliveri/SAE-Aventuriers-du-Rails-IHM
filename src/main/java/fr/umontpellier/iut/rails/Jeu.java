...
public class Jeu extends Task<Void> implements IJeu {
     ...
     */
    private ObservableList<CouleurWagon> defausseCartesWagon;
    /**
    ...
    public Jeu(String[] nomJoueurs) {
        ...
        defausseCartesWagon = FXCollections.observableArrayList();
    ...
    /**
     * Ajout d'une méthode property pour la defausse
     **/
    public ObservableList<CouleurWagon> defausseCartesWagonProperty(){return defausseCartesWagon;}
